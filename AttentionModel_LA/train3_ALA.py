...
vNumber = 3  # local attention with spatial information (model uses a guide (spatial information) as local attention point)
...
training_gt_rate = 0  # 1.1: 정답값으로만 학습, 0: 예측값으로만 학습  --> 매 예측 point 마다 rate를 정해야 함
''' ======================================================================== '''
